    ...
    <div class="bg-gray-50">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div
          ...
          class="rounded-lg border-2 shadow-sm relative bg-orange-100 border-none"
        >
              ...
              >
                <p class="flex items-center gap-1.5 sm:gap-1">
                  ...
                  <span class="whitespace-nowrap"
                    >modifié le {{ formatFrenchDate(store.selectedPost.updatedAt) }}</span
                  >
                </p>
                <p class="flex items-center gap-1.5 sm:gap-1">
                  <svg
                  ...
                  >
                    ...
                    ></path></svg><span class="whitespace-nowrap"
                    >{{ store.selectedPost.content[0].length }} caractères</span
                  >
                </p>
              </div>
            </div>
